...
def side_effect_test(value):
    ...
    value[1] = "orange"
    print("Inside the function, the value becomes {}".format(value.values()))
...
if __name__ == "__main__":
    ...
    print("Outside the function, the value cdtarts as {}".format(value.values()))

    side_effect_test(value)

    print("Outside the function, the value is now {}".format(value.values()))